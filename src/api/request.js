...
const request = axios.create({
  ...
  baseURL: 'http://192.168.137.1:13400/omc/api/',
  timeout: 5000,
  headers: {
    'Content-Type': 'application/json;charset=UTF-8'
    // authentication: getAccessToken()
    // ? getAccessToken()
    // : 'eyJhbGciOiJIUzUxMiIsInppcCI6IkdaSVAifQ.H4sIAAAAAAAAAKtWKi5NUrJSKs5IzFfSUUqtKFCyMjQzMTU3NDIxMa0FAMWRbYcfAAAA.a2lT7Zf7bxQsgQeRwYokcjKwYb_c3K9LO-e8iZ1hqkSjPklSED6ajAuDWJqwRGYZqRlFGIy2L4XabnE4vVBEdA' // headers塞token
  }
})
// http://192.168.137.1:13400/omc/api/common/update/accessToken
