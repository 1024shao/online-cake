...
// refresh Token access_token过期 刷新token
// export const reqRefreshToken = () => request({ url: '', method: 'post',{ refresh_token: getRefreshToken() }})
export const reqTestFile = (data) => request.post('/admin/goods/upload/image', data)